    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #1e4f87;">
        ...
        <div class="collapse navbar-collapse" id="main_nav" style="justify-content: center;">
            ...
            <ul class="navbar-nav">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item " href="#"> Long Term Program (Newly Recruited) &raquo </a>
                            <ul class="submenu dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="newly_recruited_ofs.php">Newly Recruited Odisha Finance Service Officers</a>
                                </li>
                                <li><a class="dropdown-item" href="newly_recruited_ot&as.php">Newly Recruited Odisha Taxation & Account Service
                                        Officers</a></li>
                        ...
                        <li><a class="dropdown-item" href="#"> Long Term Program (In Service) &raquo </a>
                           <ul class="submenu dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="promoted_ofs.php">Promoted Odisha Finance Service Officers</a>
                                </li>
                        ...
                        <li><a class="dropdown-item" href="#">Medium Term Program &raquo </a>
                            <ul class="submenu dropdown-menu">
                                <li><a class="dropdown-item" href="ministerial_program.php">Career Promotion Training programme for Ministerial
                                        Employees</a></li>
                                <!-- <li><a class="dropdown-item" href="">Refresher Training Programme for Asst. Commercial
                                        Tax Officers</a></li>
                                <li><a class="dropdown-item" href="">Refresher Training Programme for Common Cadre
                                        Auditors</a></li> -->
                        ...
                        <li><a class="dropdown-item" href="#"> Short Term Program &raquo</a>
                            <ul class="submenu dropdown-menu">
                                <li><a class="dropdown-item" href="">Training Programme on Financial Management for DDOs
                                        of Health & Family Welfare Department</a></li>
                                <li><a class="dropdown-item" href="">Training Programme on Financial Management for DDOs
                                        of School & Mass Education Department</a></li>
                                <li><a class="dropdown-item" href="">Training Programme on Financial Management at Micro
                                        Level for the Accountants</a></li>
                                <li><a class="dropdown-item" href="">Training Programme on e-pension of Jail and
                                        Correctional Officers of Prison Organisation</a></li>
                                <li><a class="dropdown-item" href="">Training Programme on Goods and Services Tax</a>
                                </li>
                            </ul>
                        </li>
                ...
                <!-- <li class="nav-item"> <a class="nav-link" href="#" style="color:#fff">Library </a> </li> -->
                 <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#"> About Library </a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item" style="margin-left: 119px;"> <i class="fa fa-unlock-alt" aria-hidden="true" style="color: sandybrown;"></i><a class="nav-link" href="login.php" style="color:#fff">ITMS</a></li>
