        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-10">
                    <div class="wrap d-md-flex" style="margin-top: 4%;">
						<div class="col-md-8">
							<div class="row">
							<div class="col-md-12">
						...
						<div class="row" style="margin-left: 10%;background-color:">
						...
						<div class="row" style="margin-left: 10%;line-height: 3rem;">
						<div class="col-md-3 pd0">
                        ...
                        <div class="col-md-4" style="background-image: url(library/login_bg.jpg);background-size: 31rem 35rem;background-repeat: no-repeat;">
						...
						<div class="login-wrap" style="margin: 0 auto;">
                            ...
                            <form action="#" class="signin-form" method="post">
                                ...
                                <div class="form-group">
                                    <button type="submit" name="submit" class="form-control rounded submit ml-3 px-3"
