...
<body>
    ...
    <section class="header" style="display: block;height:122px;background-color: #fff;">
        <div class="header-wrap d-flex justify-content-between">
            <div class="header-logo logo">
              
                <img src="images/madhusudan.jpg" style="height:120px;margin-left: 10px;">
            </div>
                    ...
                    <div class=""><br>
                        <a href="index-2.html" style="text-decoration: azure;">
                            <h1
                                ...
                                Madhusudan Das
                                Regional Academy <br>of Financial Management (MDRAFM), Bhubaneswar</h1>
                        </a>
                    </div>
            ...
            <div class="header-logo logo d-flex cm">
                ...
                <div>
                    <img src="images/cm.png" style="height:120px;margin-right:10px">
                </div>
    ...
    <section  class="header-mobile" style="display: none;height:30%;background-color: #fff;">
      <div class="header-img d-flex" >
          <div class="header-logo logo">
              ...
              <img src="images/madhusudan.jpg" style="height:80px;margin-left: 10px;">
          </div>
        ...
        <div class="header-top top d-flex">
                  ...
                  <div class="container" >
                      ...
                      <div class=""><br>
                          <a href="index-2.html" style="text-decoration: azure;">
                              <h3
                                  style="font-size: 1rem;font-family: serif;user-select: auto;font-weight:bold;color:#2551b5">
                                  Madhusudan Das
                                  Regional Academy <br>of Financial Management (MDRAFM), Bhubaneswar</h3>
                          </a>
                      </div>
