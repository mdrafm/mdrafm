                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Parmanent Address" id="pr_addr">
                        </div>
                    </div>
                </div>
                <div class="row">
                   ...
                   <label><strong>District Name</strong></label>
                            <input type="text" class="form-control" placeholder="Enter Parmanent Address" id="dist" value="<?php echo $dist  ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 px-1">
                        <div class="form-group">
                          ...
                          <input type="text" disabled class="form-control" placeholder="Enter Parmanent Address" id="dist1" value="<?php echo $dist  ?>">  
                        </div>
                    </div>
                    <div class="col-md-4 pl-1">
                        <div class="form-group">
