    ...
    <div class="wrapper ">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="menu1" class="container">
                                <h5 class="text-center">Add New Tranee </h5><br>
                                ...
                                <?php 
                                    ...
                                    $mdrafm_status = 0;
                                    $db->select($table,"id,trng_type,mdrafm_status",null,"dept_email = '".$_SESSION['username']."' ",null,null );
                                                            ...
                                                            <div class="modal-content" style="width:150%">
                                                                ...
                                                                <div class="modal-footer" id="m_footer">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary"
                                                                        ...
                                                                        onclick="edit('new tranee','frm_newTranee_update_<?php echo $row['id']; ?>','tbl_dept_trainee_registration',<?php echo $row['id']; ?>)">Update</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        ?>
                                ...
                                <?php 
                                  if($mdrafm_status == 0){
                                    ?>
                                      <input type="button" class="btn btn-success" onclick="send_to_mdrafm(<?php echo $porg_id ?>,'<?php echo $table ?>')"  name="submit" value="Send to MDRAFM" />
                                    <?php
                                  }else{
                                    ?>
